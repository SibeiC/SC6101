...
\author{\IEEEauthorblockN{Full Name of Student}
\IEEEauthorblockA{Student'€™s Matriculation Number \\
\textit{Name of Student's School}\\
\textit{Nanyang Technological University}\\
Singapore \\
Email address of Student}
\and
\IEEEauthorblockN{Full Name of Student}
\IEEEauthorblockA{Student's Matriculation Number \\
\textit{Name of Student'€™s School}\\
\textit{Nanyang Technological University}\\
Singapore \\
...
You should also mention exactly which issue out of the three â€“ Security, Privacy, Scalability â€“ you are going to present, and what would be the overall contribution of this paper. Argument as why this issue is the most important is not required here.
